...
const mounted = ref(0);
const cookies_enabled = ref(false);
...
<template>
  ...
  <nav>
    <RouterLink class="ml-3" to="/">Go to home</RouterLink>
    ...
    <div class="mt-3">
      <div><b>Consent given:</b> {{ cookies_enabled }}</div>
